...
export const arionPricingTool = createTool({
  ...
  description:
    'Read Arion bank pricing from saved scrape files on disk. Requires all four scrape outputs; if missing, call scrape-bank-pricing first. For cross-bank comparisons use compare-bank-pricing instead. Pass language ("is" or "en") and topic to filter results.',
